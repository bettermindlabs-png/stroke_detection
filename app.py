...
# Sidebar
st.sidebar.image("https://upload.wikimedia.org/wikipedia/commons/3/3a/Stroke_illustration_%28CDC%29.png")
...
with col1:
    st.image("https://www.cdc.gov/stroke/images/stroke-brain.png")
